    ...
    <nav id="mainNav" class="navbar navbar-default navbar-custom navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="<?php echo base_url(); ?>pelayan">SMTI-08 RESTO</a>
            </div>
            <!-- /.navbar-collapse -->
        </div>
        <!-- /.container-fluid -->
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">DAFTAR MENU YANG DIANTAR</h2>
                    <div class="row text-center">
                        <table style='width:80%'class='table table-bordered'>
                            <div>
                                ...
                                $a = $this->db->query("SELECT * FROM pembeli WHERE status=3 OR status=4");
                                $no_urut = 1;
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <?php echo form_open('Pelayan/status', array('name' => 'status'))?>
